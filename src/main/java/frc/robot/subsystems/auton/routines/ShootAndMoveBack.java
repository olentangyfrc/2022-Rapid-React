...
import frc.robot.subsystems.drivetrain.commands.LeaveTarmac;
...
public class ShootAndMoveBack extends SequentialCommandGroup {
  ...
  public ShootAndMoveBack(SwerveDrivetrain drivetrain, ShooterSubsystem shooter, BallIntake intake, Pose2d startPos) {
