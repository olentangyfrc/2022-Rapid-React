...
public class BlueStartOne_TwoCargo extends SequentialCommandGroup {
  /** Creates a new BlueStartOne_TwoCargo. */
  public BlueStartOne_TwoCargo(SwerveDrivetrain drivetrain, BallIntake intake, ShooterSubsystem shooter, AutonPaths paths) {
    // Add your commands in the addCommands() call, e.g.
    // addCommands(new FooCommand(), new BarCommand());
    addCommands(
      new ResetLocation(drivetrain, paths.getStartB1ToCargo3_1().getStartPosition()),
      new StartIntake(intake),
      new FollowTrajectoryCommand(drivetrain, paths.getStartB1ToCargo3_1()),
