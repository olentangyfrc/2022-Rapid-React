...
public class RedStartTwo_FourCargo extends SequentialCommandGroup {
  /** Creates a new RedStartTwo_FourCargo. */
  public RedStartTwo_FourCargo(SwerveDrivetrain drivetrain, BallIntake intake, ShooterSubsystem shooter, AutonPaths paths) {
    // Add your commands in the addCommands() call, e.g.
    // addCommands(new FooCommand(), new BarCommand());
    addCommands(
      new ResetLocation(drivetrain, paths.getStartR2ToCargo12_5().getStartPosition()),
      new StartIntake(intake),
      new FollowTrajectoryCommand(drivetrain, paths.getStartR2ToCargo12_5()),
      new ShootBallAuton(drivetrain, shooter, intake, 2),
      new FollowTrajectoryCommand(drivetrain, paths.getCargo12ToCargo11_5()),
      new ShootBallAuton(drivetrain, shooter, intake, 1),
      new FollowTrajectoryCommand(drivetrain, paths.getCargo11ToCargo14_5()),
